<div class="well" style="padding-top: 20px 0;">
        <ul class="nav nav-list">
          ...
          <li><a href="/agencia_vuelos/index.php/reservaciones"><i class="icon-book"></i> Reservaciones</a></li>
          <li><a href="/agencia_vuelos/index.php/usuario"><i class="icon-pencil"></i> Usuarios</a></li>
          <li><a href="/agencia_vuelos/index.php/vuelos"><i class="icon-plane"></i> Vuelos</a></li>
